...
const cartItem = [
	{
		...
		courseImage: 'https://images.unsplash.com/photo-1695309534427-12bdf0afdd0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
		subjectName: 'ReactJS',
		ratings: 4.6,
		reviews: 100.345,
		courseDuration: '35h',
	...
	},
	{
		...
		courseImage: 'https://images.unsplash.com/photo-1695075989376-ac0e8549ec8f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxOHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
...
function Cart() {
	...
	useEffect(() => {
		...
		let newTotalPrice = 0;
		console.log('🚀 ~ file: Cart.js:146 ~ useEffect ~ carts:', carts);
		if (carts) {
						...
						<>
							<Row>
								<Col
									...
									md='7'
									sm='12'>
									<h3 className='font-weight-600 text-dark'>{carts.length} khóa học trong giỏ hàng</h3>
													...
													<Link
														...
														<Row>
															...
															<Col
																...
																md='8'
																sm='8'>
																<p className='font-weight-700 text-dark m-0 p-0'>{cart.courseName}</p>
																<span className='text-muted'>{/* Môn học: <strong>{cart.subjectName}</strong> */}</span>
																<div className='d-flex text-dark'>
																	<span className='font-weight-600'>{cart.ratings}</span>
																	<div className='mx-2'>
																...
																<div className='d-flex justify-content-start'>
																	<span className='text-muted'>{cart.courseDuration}</span>
																	<span className='mx-2'>-</span>
																	<span className='text-muted'>{cart.numberSession} bài giảng</span>
																	<span className='mx-2'>-</span>

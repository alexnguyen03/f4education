...
import {Breadcrumbs, Anchor, Text, Loader, Image, Card, Box, Flex, Group, Rating, Skeleton} from '@mantine/core';
...
function Cart() {
	...
	return (
		<>
			...
			<h3 className='font-weight-700 text-dark my-5 display-3'>Những khóa học mới nhất</h3>

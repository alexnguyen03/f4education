...
function CourseClient() {
    ...
    const findCoursesByCheckedRating = async (selectedRating) => {
        try {
            setLoading(true)
            const resp = await courseApi.findCoursesByCheckedRating(
                selectedRating,
                user !== null ? user.username : ''
            )
            setCourses(resp.data.reverse())
    ...
    useEffect(() => {
        findCoursesByCheckedRating(selectedRating)
    }, [selectedRating])
            ...
            <Container size="xxl">
                ...
                <div className="d-flex">
                    <div className="pl-0 col-3">
                        ...
                        <div className="col-lg-12 pl-0 pr-2 pb-2">

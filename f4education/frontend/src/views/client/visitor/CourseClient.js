    ...
    <>
      ...
      <div className="d-flex mb-3">
        <div class="pl-0 pt-2 pr-2 pb-2">
          ...
          >
            <FilterListIcon />
            <span className="ml-1 font-weight-bold text-dark">Bộ lọc</span>
          </div>
        </div>
        <div class="p-2">
          <div
        ...
        <div className="pl-0 col-4">
          <div className="col-lg-12 pl-0 pt-2 pr-2 pb-2">
            <div className="border-top border-bottom pt-3">
              <div onClick={toggleAccordionRating} className="my-2">
                <h3 className="mb-4">
                  Xếp hạng
                  {expandedRating ? (
          ...
          <div className="col-lg-12 pl-0 pt-2 pr-2 pb-2">
            <div className="border-bottom pt-3">
              <div onClick={toggleAccordionTopic} className="my-2">
                <h3 className="mb-4">
                  Chủ đề
                  {expandedTopic ? (
                    <ExpandLess style={{ float: "right" }} />
              ...
              {expandedTopic && (
                <div>
                  {subjects.map((subject) => (
                    <div className="form-check mb-3" key={subject.subjectId}>
                      <input
                        className="form-check-input"
                        type="checkbox"
                        ...
                        checked={checkedSubjects.includes(subject.subjectName)}
                      />
                      <label
          ...
          <div className="col-lg-12 pl-0 pt-2 pr-2 pb-2">
            <div className="border-bottom pt-1">
              <div onClick={toggleAccordionDuration} className="my-2">
                <h3 className="mb-4">
                  Thời lượng
                  {expandedDuration ? (
                    <ExpandLess style={{ float: "right" }} />
        ...
        <div className="p-2 col-8">
          {isLoading ? (
            ...
            currentCourses.map((course) => (
              <div className="d-flex border-bottom mb-3" key={course.courseId}>
                ...
                <div className="col-lg-7 mb-3">
                  ...
                  <span class="text-dark small">
                    <b>Chủ đề:</b> {course.subject.subjectName}
                  </span>
                  <br />
                  <b>4.0</b>
                  <span className="ml-2">
                  ...
                  <br />
                  <Badge className="p-0" size="md" color="pink" variant="light">

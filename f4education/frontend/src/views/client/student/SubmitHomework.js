...
const SubmitHomework = () => {
    ...
    const submitTask = async (className, taskName) => {
        ...
        formData.append('studentName', '21 - ' + 'Tên demo nhé')
                ...
                <Grid.Col span={8} bg={'#ebebeb'}>
                    <Group>
                        <BookmarkIcon
                            ...
                            color="success"
                        />
                        <Title order={2}>{tasks[0].className} - Task</Title>
                    </Group>
                    {tasks.map((task, indexTask) => (
                        ...
                        >
                            ...
                            <Text my={5}>Giáo viên: {task.teacherName}</Text>
                            <Text ta="right">
                                <Button
                                    variant="filled"
                                    onClick={toggle}
                            ...
                            >
                                ...
                                <div className="modal-footer">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            setShowModal(false)
                                            submitTask(task.className, task.title)
                                        }}
                                    >
                                        Nộp
                                    </Button>

  ...
  const handleAttandance = (e, studentId) => {
    students.map((student) => {
      ...
      if (
        ...
        const newStudent = students.find((st) => st.studentId.trim() === studentId.trim());
          ...
          return (
            <Button.Group>
              ...
              <Button
                ...
                variant="outline"
                color={
                  seletedStudent.studentId === row.studentId ? "red" : "gray"
                }
                onClick={(e) => {
                  handleAttandance(e, row.studentId);
                }}
            ...
            {loading ? (
              <>
                <Flex direction="column" justify="center" align="center">
                  <Skeleton width={90} height={90} circle mb={25} mt={90} />
                  <Skeleton width="100%" height={15} mb={15} />
                  <Skeleton width="100%" height={15} mb={15} />
                  <Skeleton width="100%" height={15} mb={15} />
                  <Skeleton width="100%" height={15} mt={25} />
                </Flex>
              </>
            ) : (
              <>
                <Card padding="xl" radius="md" className={styles.card}>
                  <Card.Section
                    h={140}
                    style={{
                      backgroundImage:
                  ...
                  <Text c="dimmed" mt="md" fz="md" align="center" gap={30}>
                    Từ ngày {moment(classInfor.startDate).format("DD/mm/yyyy")}{" "}
                    - {moment(classInfor.endDate).format("DD/mm/yyyy")}
                  </Text>
                  <Flex align={"center"} justify="space-between" mt="lg">
                    <Text ta="center" fz="md" c="dimmed" align="left">
                      Trạng thái:
                    </Text>
          ...
          <Box className={styles["box-content"]}>
            <Flex justify="space-between" align="center">
              ...
              <Text color="dark" fz="lg" fw={500}>
                Tổng sinh viên: {students.length > 0 ? students.length : 0} /{" "}

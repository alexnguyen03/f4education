				...
				<div
					...
					<ul
						...
						<li className='nav-item'>
							<Link
								to={'/'}
								className={activeItems[0] ? 'nav-link custom-nav-link active' : 'nav-link custom-nav-link'}
						...
						<li className='nav-item'>
							<Link
								to={'/course'}
								className={activeItems[1] ? 'nav-link custom-nav-link active' : 'nav-link custom-nav-link'}
						...
						<li className='nav-item'>
							<Link
								to={'/cart'}
								className={activeItems[2] ? 'nav-link custom-nav-link active' : 'nav-link custom-nav-link'}
																...
																<>
																	<Row className='mt-2'>
																		...
																		<Col
																			...
																			<span className='font-weight-900 text-dark align-items-start'>{cart.course.courseName}</span>
